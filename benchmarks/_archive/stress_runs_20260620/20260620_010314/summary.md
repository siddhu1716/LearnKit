...
|---|---|---|---|---|---|---|---|---|
| control | python_debugging | 18 | 3 | 3.44 | 0.12 | 270 | 0.52 | 0 |
| treatment | python_debugging | 18 | 3 | 3.39 | 0.23 | 413 | 0.55 | 551 |

## Lift: treatment − control (per domain)

| Domain | Control mean | Treatment mean | Δ score | Relative |
|---|---|---|---|---|
| python_debugging | 3.44 ± 0.12 | 3.39 ± 0.23 | -0.05 | -1.3% |

## Compounding curve (treatment score by task index)

| Domain | t1 | t2 | t3 | t4 | t5 | t6 | t7 | t8 | t9 | t10 | t11 | t12 | t13 | t14 | t15 | t16 | t17 | t18 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| python_debugging | 5.0 | 5.0 | 5.0 | 3.5 | 3.5 | 2.5 | 3.5 | 5.0 | 0.0 | 2.0 | 5.0 | 1.5 | 3.5 | 1.5 | 3.5 | 5.0 | 3.5 | 5.0 |

## LearnKit context size by task index (treatment)

| Domain | t1 | t2 | t3 | t4 | t5 | t6 | t7 | t8 | t9 | t10 | t11 | t12 | t13 | t14 | t15 | t16 | t17 | t18 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| python_debugging | 0 | 922 | 0 | 0 | 0 | 0 | 1078 | 843 | 872 | 0 | 1035 | 1201 | 1222 | 0 | 0 | 1175 | 916 | 1160 |
